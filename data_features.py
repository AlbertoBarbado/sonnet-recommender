...
def docs2dict():
    ...
    for file_path in list_docs:
        ...
        for index, data in dct_data.items():
            ...
            ##### Whole Text
            _, list_lem, list_lem_ngrams, list_lem_complete = word_preprocessing(data['text'])
            ...
            # Rename cols
            data.update({'words_lem':list_lem, 
            ...
            for key, dct_stanza in data['dct_stanzas'].items():
                _, list_lem, list_lem_ngrams, list_lem_complete = word_preprocessing(dct_stanza['text'])
                # Add affective features
                ...
                # Rename cols
                data['dct_stanzas'][key].update({'words_lem':list_lem, 
                                                 'words_lem_ngrams':list_lem_ngrams,
                                                 'words_lem_complete':list_lem_complete})
                # string of words (ngram)
                s = ''
